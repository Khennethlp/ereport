<script>
  ...
  const export_records = () => {
    var search_serial = document.getElementById('search_by_serialNo').value;
    var search_batch = document.getElementById('search_by_batchNo').value;
    var search_group = document.getElementById('search_by_groupNo').value;
    var search_tgroup = document.getElementById('search_by_tgroup').value;
    var search_docs = document.getElementById('search_by_docs').value;
    var search_filename = document.getElementById('search_by_filename').value;
    var search_month = document.getElementById('search_by_month').value;
    var search_year = document.getElementById('search_by_year').value;

    // Create a hidden form for submission
    var form = $('<form></form>').attr({
      method: 'POST',
      action: '../../process/export/export_records.php'
    });

    // Append each search field to the form as hidden input
